...
public class BreakLightSourcesGoal extends Goal {
    ...
    private static final TagKey<EntityType<?>> AFFECTED_ENTITIES = TagKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(Reference.MOD_ID, "affected_entities"));
    ...
    public static boolean isAffectedEntity(Mob mob) {
        return mob.is(AFFECTED_ENTITIES);
    }
